...
import com.libsocket.sdk.connection.AbsReconnectionManager;
import com.libsocket.sdk.connection.DefaultReconnectManager;
import com.libsocket.sdk.connection.abilities.IConfiguration;
import com.libsocket.sdk.protocol.DefaultNormalHeaderProtocol;
...
public class OkSocketOptions {
     ...
     * 抛出{@link com.libsocket.impl.exceptions.DogDeadException}
     */
    ...
    public static class Builder {
         ...
         * 脉搏丢失次数<br>
         * 大于或等于丢失次数时将断开该通道的连接<br>
         * 抛出{@link com.libsocket.impl.exceptions.DogDeadException}<br>
         * 默认是5次
         *
         ...
         * 如果不需要断线重连请设置该参数为{@link com.libsocket.sdk.connection.NoneReconnect}
         *
