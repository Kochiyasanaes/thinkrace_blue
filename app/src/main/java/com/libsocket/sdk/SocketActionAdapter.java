...
public abstract class SocketActionAdapter implements ISocketActionListener {
     ...
     *
     * @param context 上下文
     * @param action  {@link com.libsocket.sdk.connection.interfacies.IAction#ACTION_READ_THREAD_START}
     *                {@link  com.libsocket.sdk.connection.interfacies.IAction#ACTION_WRITE_THREAD_START}
     */
    @Override
     ...
     *
     * @param context 上下文
     * @param action  {@link com.libsocket.sdk.connection.interfacies.IAction#ACTION_READ_THREAD_SHUTDOWN}
     *                {@link  com.libsocket.sdk.connection.interfacies.IAction#ACTION_WRITE_THREAD_SHUTDOWN}
     ...
     * @param action  {@link com.libsocket.sdk.connection.interfacies.IAction#ACTION_DISCONNECTION}
     ...
     * @param context 上下文
     * @param info    这次连接的连接信息
     * @param action  {@link com.libsocket.sdk.connection.interfacies.IAction#ACTION_CONNECTION_SUCCESS}
     */
    @Override
     ...
     * @param context 上下文
     * @param info    这次连接的连接信息
     * @param action  {@link com.libsocket.sdk.connection.interfacies.IAction#ACTION_CONNECTION_FAILED}
     ...
     *
     * @param context 上下文
     * @param action  {@link com.libsocket.sdk.connection.interfacies.IAction#ACTION_READ_COMPLETE}
     ...
     *
     * @param context 上下文
     * @param action  {@link com.libsocket.sdk.connection.interfacies.IAction#ACTION_WRITE_COMPLETE}
