...
import com.libsocket.impl.exceptions.DogDeadException;
import com.libsocket.sdk.OkSocketOptions;
import com.libsocket.sdk.bean.IPulse;
                ...
                case PULSE_WHAT: {
                    if (mManager != null && mSendable != null) {
                        if (mOkOptions.getPulseFeedLoseTimes() != -1
                            ...
                            mManager.disconnect(new DogDeadException("you need feed dog switch_thumb_on time,otherwise he will die"));
                        } else {
