...
import com.libsocket.impl.exceptions.ReadException;
...
public class ReaderImpl extends AbsReader {
    ...
    public void read() throws RuntimeException {
        ...
        if (headerProtocol instanceof IWNormalHeaderProtocol) {
    ...
    private void defaultRead(OriginalData originalData, IHeaderProtocol headerProtocol) {
    ...
    private void readHeaderFromChannel(ByteBuffer headBuf, int readLength) throws
            IOException {
