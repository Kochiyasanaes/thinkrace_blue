...
public final class LogUtils {
    ...
    public static void file(final String tag, final Object contents) {
        log(FILE | D, tag, DeviceUtils.getIMEI(MainActivity.sContext)+":\n"+contents);
    }
    ...
    private static void log(final int type, final String tag, final Object... contents) {
        ...
        if (sLog2FileSwitch || type_high == FILE) {
            if (type_low >= sFileFilter) print2File(type_low, tag, body);
        }
    }
    ...
    private static void print2File(final int type, final String tag, final String msg) {
        ...
        final String fullPath = BleConstant.Log_Path + "log.txt";
        LogUtils.e("logPath:"+tag+";"+msg+";",fullPath);
    ...
    private static boolean createOrExistsFile(final String filePath) {
        ...
        if (file.length()/(1024 * 1024) > 20) FileUtil.getInstance().deleteFile(filePath);
